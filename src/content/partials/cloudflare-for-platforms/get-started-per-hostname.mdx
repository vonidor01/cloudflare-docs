...
Custom Hostnames pointing to Static IPs or BYOIPs that are associated to your account will validate, even if the IP is not the assigned apex proxying IP allocated for your account!
